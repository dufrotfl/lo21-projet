...
\begin{DoxyCompactList}\small\item\em Classe implémentant l'interface de \hyperlink{class_nombre_non_complexe}{Nombre\-Non\-Complexe} et permettant de gérer les constantes de type rationnel. \end{DoxyCompactList}\end{DoxyCompactItemize}
